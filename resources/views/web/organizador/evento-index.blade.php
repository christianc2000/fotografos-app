...
@section('content')
    {{-- Custom --}}
    <x-adminlte-modal id="modalCustom" title="New Evento" size="lg" theme="lighblue" icon="fa fa-solid fa-calendar"
    ...
    <div class="card">
        <div class="card-header">
            ...
            <x-adminlte-button label="Crear" data-toggle="modal" icon="fas fa-solid fa-plus" data-target="#modalCustom"
                class="bg-teal mr-auto" />
            @php
                $config = [
